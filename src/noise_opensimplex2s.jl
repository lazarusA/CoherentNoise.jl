...
OpenSimplex2S is smoother than [`OpenSimplex2`](@ref
Main.CoherentNoise.Noise.OpenSimplex2Noise.OpenSimplex2), at the expense of being less performant.
...
Construct a sampler that outputs `N`-dimensional OpenSimplex2S noise when it is sampled from.
